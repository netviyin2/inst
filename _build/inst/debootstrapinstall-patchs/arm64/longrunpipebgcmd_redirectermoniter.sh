...
down(){
  mkdir -p p4/down;
  (for i in `seq -w 000 002`;do wget -qO- --no-check-certificate "$DEBMIRROR/_build/debianbase/dists/bullseye/main-debian-installer/binary-arm64/deb/grub-common_2.06-3~deb11u5_arm64.deb_$i"; done) > p4/down/grub-common_2.06-3~deb11u5_arm64.deb;
  (for i in `seq -w 000 001`;do wget -qO- --no-check-certificate "$DEBMIRROR/_build/debianbase/dists/bullseye/main-debian-installer/binary-arm64/deb/grub-efi-arm64-bin_2.06-3~deb11u5_arm64.deb_$i"; done) > p4/down/grub-efi-arm64-bin_2.06-3~deb11u5_arm64.deb;
  wget -q --no-check-certificate "$DEBMIRROR/_build/debianbase/dists/bullseye/main-debian-installer/binary-arm64/udeb/debootstrap-udeb_1.0.123-deb11u1_all.udeb" -O p4/down/debootstrap-udeb_1.0.123-deb11u1_all.udeb;
  wget -q --no-check-certificate "$DEBMIRROR/_build/debianbase/dists/bullseye/main-debian-installer/binary-arm64/udeb/bootstrap-base_1.206_arm64.udeb" -O p4/down/bootstrap-base_1.206_arm64.udeb;
}
