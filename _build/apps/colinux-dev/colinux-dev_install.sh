...
PATH=/usr/local/gcc-4.1.2/bin:$PATH make CFLAGS="-O2 -fgnu89-inline" BOOT_CFLAGS="-O2 -fgnu89-inline" CFLAGS_FOR_TARGET="-g -O2 -I/usr/include -I/usr/include/i386-linux-gnu" -j$(nproc)
