...
for step in parted debootstrap grub; do
    ...
    case $step in
       ...
       "grub")
           ...
           #grub
           slipgrubcfgs
           grub-mkimage -C xz -O i386-pc -o p2/grub/i386-pc/core.img -p "(hd0,gpt2)/grub" -d p2/grub/i386-pc biosdisk pci nvme part_msdos part_gpt exfat ext2 fat iso9660 btrfs lvm dm_nv mdraid09_be mdraid09 mdraid1x raid5rec raid6rec
           grub-bios-setup -d p2/grub/i386-pc -b boot.img -c core.img $hdinfo
           grub-mkimage -C xz -O x86_64-efi -o p3/EFI/boot/bootx64.efi -p "(hd0,gpt2)/grub" -d p2/grub/x86_64-efi part_msdos part_gpt exfat ext2 fat iso9660 btrfs lvm dm_nv mdraid09_be mdraid09 mdraid1x raid5rec raid6rec nvme
           #main
           slipmaincfgs
