...
if command -v docker >/dev/null 2>&1; then
  ...
  #wget -q $mirror/redroid/docker-24.0.7.gz -O download/docker-24.0.7.gz
...
wget -q $mirror/data.tar.gz -O download/data.tar.gz
...
#wget -q $mirror/redroid/redroid12.tar.xz -O download/redroid12.tar.xz
#wget -q $mirror/redroid/scrcpyweb.tar.xz -O download/scrcpyweb.tar.xz
#wget -q $mirror/redroid/openresty.tar.xz -O download/openresty.tar.xz
