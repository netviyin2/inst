...
chmod 644 /usr/local/share/GeoIP/GeoIP.dat
...
SERVER_GROUP=3
PUBLIC_IP=$(curl -s -m 20 https://ipinfo.io/ip || echo "PUBLIC_IP")
MAIN_BRIDGE_IP=$PUBLIC_IP
OPEN_CHANNEL='11,52'
...
cp ${DNFS_DIR}/libGeoIP.so.1 /usr/lib/i386-linux-gnu/
cp ${DNFS_DIR}/libGeoIP.so.1 /lib/i386-linux-gnu/
