...
#########edtion2
  ...
  [[ $tmpHOSTARCH == '0' ]] && grub-mkimage -C xz -O i386-pc -o "$tmpMNT"_p2/grub/i386-pc/core.img -p "(hd0,gpt2)/grub" -d "$tmpMNT"_p2/grub/i386-pc biosdisk pci nvme part_msdos part_gpt exfat ext2 fat iso9660 btrfs lvm dm_nv mdraid09_be mdraid09 mdraid1x raid5rec raid6rec
