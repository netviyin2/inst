...
if [[ ${prompt,,} =~ ^(y|yes)$ ]]; then
    ...
    echo -e "add tmpinstall/10.xml /autounattend.xml\nadd tmpinstall/10.xml /autounattend.dat" | wimlib-imagex update tmpinstall/extracted/sources/boot.wim 2 --command
    # updateimage end
