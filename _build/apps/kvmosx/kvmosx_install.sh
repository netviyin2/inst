...
wget --no-check-certificate $mirror/boot.img.gz -O download/boot.img.gz
# from https://raw.githubusercontent.com/kholia/OSX-KVM
wget --no-check-certificate $mirror/OVMF_CODE.fd -O download/OVMF_CODE.fd
wget --no-check-certificate $mirror/OVMF_VARS.fd -O download/OVMF_VARS.fd
wget --no-check-certificate $mirror/fetch-macOS-v2.py -O download/fetch.py
